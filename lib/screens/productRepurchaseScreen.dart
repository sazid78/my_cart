...
class ProductRepurchaseScreen extends StatefulWidget {
  static const String routeName = '/repurchase';
  const ProductRepurchaseScreen({Key? key}) : super(key: key);

  @override
  State<ProductRepurchaseScreen> createState() => _ProductRepurchaseScreenState();
}

class _ProductRepurchaseScreenState extends State<ProductRepurchaseScreen> {
  ...
  void _repurchase() {
    if(purchaseDate == null) {
      appSnackMessage(context, 'Please select a purchase date');
      return;
    }
